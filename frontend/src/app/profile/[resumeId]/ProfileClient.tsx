...
function ProfileDataCard({
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="rounded-xl border border-[#1E2D45] bg-[#111827] p-5"
    >
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-400">
                  ...
                  distribution, and a live skills constellation.
                </p>
          ...
          <section className="rounded-[2rem] border border-[#1E2D45] bg-[#0B1120] p-6 shadow-sm lg:p-8">
            <div className="mb-6 max-w-2xl">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Structured fields from your resume, paired with the skills
            ...
            <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-2">
              ...
              <motion.div
                ...
                className="sticky top-6 h-fit min-h-[400px] overflow-hidden rounded-xl border border-[#1E2D45] bg-[#111827]"
              >
                <SkillsConstellation
